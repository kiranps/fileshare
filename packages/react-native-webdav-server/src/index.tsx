...
import installer from './NativeWebdavServer';
...
export * from './generated/webdavserver';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as webdavserver from './generated/webdavserver';
...
if (!initialized) {
  webdavserver.default.initialize();
  initialized = true;
}
