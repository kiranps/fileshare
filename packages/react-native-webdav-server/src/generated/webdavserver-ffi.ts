...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_webdavserver_fn_constructor_webdavserver_new(uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_webdavserver_fn_method_webdavserver_start(ptr: bigint, opts: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
