...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_webdavserver_fn_clone_p2pconnection(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus,
  ): bigint;
  ubrn_uniffi_webdavserver_fn_free_p2pconnection(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus,
  ): void;
  ubrn_uniffi_webdavserver_fn_constructor_p2pconnection_new(
    uniffi_out_err: UniffiRustCallStatus,
  ): bigint;
  ubrn_uniffi_webdavserver_fn_method_p2pconnection_start(
    ptr: bigint,
    opts: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_webdavserver_fn_method_p2pconnection_stop(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ...
  ubrn_uniffi_webdavserver_checksum_method_p2pconnection_start(): number;
  ubrn_uniffi_webdavserver_checksum_method_p2pconnection_stop(): number;
  ...
  ubrn_uniffi_webdavserver_checksum_constructor_p2pconnection_new(): number;
  ...
  ubrn_uniffi_internal_fn_method_p2pconnection_ffi__bless_pointer(
    pointer: bigint,
    uniffi_out_err: UniffiRustCallStatus,
  ): UniffiRustArcPtr;
